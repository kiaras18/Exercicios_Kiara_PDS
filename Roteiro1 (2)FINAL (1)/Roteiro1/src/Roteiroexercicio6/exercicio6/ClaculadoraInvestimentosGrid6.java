...
public class ClaculadoraInvestimentosGrid6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClaculadoraInvestimentosGrid6 frame = new ClaculadoraInvestimentosGrid6();
	 ...
	 * Create the frame.
	 */
	public ClaculadoraInvestimentosGrid6() {
		setTitle("CalcInvest");
